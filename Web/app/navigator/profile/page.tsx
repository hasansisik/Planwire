...
return (
  <div>
    ...
    <div className="grid grid-cols-3 gap-4 py-5 border-b">
      ...
      <Input placeholder={user.name || "Kullanıcı Adı"} className="w-[300px]" />
    </div>
    <div className="grid grid-cols-3 gap-4 py-5 border-b">
      <div className="pb-5">
    ...
    <div className="grid grid-cols-3 gap-4 py-5 border-b">
      ...
      <Input type="password" placeholder="Şifre Tekrar" className="w-[300px]" />
    </div>
    <div className="grid grid-cols-3 gap-4 py-5 border-b">
      <div className="pb-5">
      ...
      <Input
        placeholder={user.phone || "Telefon Numarası"}
        className="w-[300px]"
      />
    </div>
    <div className="grid grid-cols-3 gap-4 py-5 border-b">
      ...
      <Input placeholder={user.email || "Mail Adresi"} className="w-[300px]" />
    </div>
  </div>
);
}
